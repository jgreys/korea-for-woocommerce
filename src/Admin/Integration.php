...
class Integration extends \WC_Integration {
        ...
        switch ( $this->category ) {
            case 'advanced':
                $this->form_fields = apply_filters(
                    'woocommerce_koreakit_advanced_settings',
                    array(
            ...
            case 'sep':
                $this->form_fields = apply_filters(
                    'woocommerce_koreakit_sep_settings',
                    array(
            ...
            case 'support':
                $this->form_fields = apply_filters(
                    'woocommerce_koreakit_support_settings',
                    array(
                        'kakaochannel'            => array(
            ...
            default:
                $this->form_fields = apply_filters(
                    'woocommerce_koreakit_general_settings',
                    array(
                        'postcode'                    => array(
    ...
    public function admin_scripts() {
        ...
        wp_enqueue_script( 'wc-koreakit-admin', plugins_url( 'assets/js/admin/settings.js', MAIN_FILE ), array(), VERSION, true );
    }
