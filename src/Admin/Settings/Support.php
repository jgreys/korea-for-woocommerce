    ...
    protected function get_settings_for_default_section() {
        $settings =
            array(
                ...
                array(
                    'type' => 'sectionend',
                    'id'   => 'woocommerce_koreakit_support_kakaochannel_settings',
                ),
                array(
                    'id'    => 'navertalktalk',
                ...
                array(
                    ...
                    'class' => 'show_if_navertalktalk_yn',
                ),
                array(
                ...
                array(
                    'type' => 'sectionend',
                    'id'   => 'woocommerce_koreakit_support_navertalktalk_settings',
                ),
            );

        return apply_filters( 'woocommerce_koreakit_support_settings', $settings );
    }
