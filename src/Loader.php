...
class Loader {
    ...
    */
    ...
    public static function hooks() {
        ...
        add_filter( 'plugin_action_links_' . plugin_basename( MAIN_FILE ), [ __CLASS__, 'plugin_action_links' ] );
    }
    ...
    public static function plugin_action_links( $links ) {
        return array_merge(
            [
                '<a href="admin.php?page=wc-koreakit-settings">' . esc_html__( 'Settings', 'korea-for-woocommerce' ) . '</a>',
                '<a href="admin.php?page=wc-koreakit-settings&tab=addons">' . esc_html__( 'Addons', 'korea-for-woocommerce' ) . '</a>',
